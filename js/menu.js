...
var menuState = {
	...
	create: function() {
        ...
        nameField_Pilot.text.text.text = "Flyboy";
        ...
        nameField_Engineer.text.text.text = "Dorkington";
        ...
        nameField_Navigator.text.text.text = "Mapsie";
        ...
        nameField_Security.text.text.text = "Ms. Fist";
